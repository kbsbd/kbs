 ...
 * drag/swipe, click-first-drag) with the pill arrows. Each card lifts and its
 * photo zooms on hover; a click opens the full-screen Lightbox at that image
 * with its caption under the photo.
 */
