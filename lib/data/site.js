...
export const DEFAULT_SITE_SETTINGS = {
  ...
  // --- properties archive ----------------------------------------------------
  // That page has no headline to edit — it is a hero photo over a search form.
  // These are the only two strings in it that were hardcoded.
  properties_hero_url:
    "/wp-content/themes/bti-new-properties-special/assets/img/demo/properties-hero.webp",
  properties_count_label: "ongoing properties",
