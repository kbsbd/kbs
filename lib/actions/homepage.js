...
export async function updatePropertiesArchive(_prevState, formData) {
  return saveSettings(
    {
      properties_hero_url: text(formData, "properties_hero_url"),
      properties_count_label: text(formData, "properties_count_label"),
    },
    ["/properties"]
  );
}
