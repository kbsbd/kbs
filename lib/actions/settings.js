...
export async function updateArrivalSettings(_prevState, formData) {
  ...
  return updateSiteSettings({
    ...
    // Added with migration 0006 — the poster frame used to be a const in
    // components/StatementOfArrival.jsx.
    arrival_thumb_url: String(formData.get("arrival_thumb_url") || "").trim() || null,
  });
}
